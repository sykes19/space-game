...
refireTime		= 18;		// Base time between shots during volley
ammoLeft		= 0;		// FIRE CODE
ammo			= 4;		// Base bullets to fire per volley
spin			= choose(1,0);
spinSpd			= 0.3;		// Base spin speed
hold_time		= 40;		// Base hold time
